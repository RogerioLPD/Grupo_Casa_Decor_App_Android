...
import 'package:nucleo_casa_decor_android/features/specifier/data/models/point_transaction.dart';
import 'package:nucleo_casa_decor_android/features/specifier/data/models/user_score.dart';
...
class SampleData {
  ...
  static const List<Company> companies = [
    Company(
      ...
      name: 'McDonald\'s',
      description:
          'Rede de fast food com lanches deliciosos e pontuação em todas as compras.',
      imageUrl:
    ...
    Company(
      ...
      name: 'Starbucks',
      description:
          'Cafeteria premium com café de qualidade e programa de fidelidade exclusivo.',
      imageUrl:
    ...
    Company(
      ...
      name: 'Nike',
      description:
          'Marca esportiva líder mundial em calçados e roupas esportivas.',
      imageUrl:
    ...
    Company(
      ...
      name: 'Amazon',
      description:
          'Marketplace online com milhões de produtos e entrega rápida.',
      imageUrl:
    ...
    Company(
      ...
      name: 'Burger King',
      description:
          'Rede de hambúrgueres grelhados com sabor único e ofertas especiais.',
      imageUrl:
    ...
    Company(
      ...
      name: 'Apple',
      description:
          'Tecnologia inovadora em smartphones, tablets e computadores.',
      imageUrl:
