...
class _PointsScreenState extends ConsumerState<PointsScreen>
  ...
  Future<void> _searchClient() async {
    ...
    try {
      ...
      _showError(
        'Erro ao buscar cliente. Verifique o CPF/CNPJ e tente novamente.',
      );
    } finally {
      setState(() {
        _isSearching = false;
              ...
              if (isDesktop)
                Row(
                  ...
                  children: [
                    Expanded(
                      flex: 2,
                      child: _buildTransactionForm(theme, isDesktop),
                    ),
                  ...
                  children: [
                              ...
                              trailing: IconButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    ...
                                    final docToFill =
                                        cpf.isNotEmpty ? cpf : cnpj;
                                    if (docToFill.isNotEmpty) {
                                      _documentController.text = docToFill
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed:
                            _isLoading || _selectedClient == null
                                ? null
                                : _processTransaction,
