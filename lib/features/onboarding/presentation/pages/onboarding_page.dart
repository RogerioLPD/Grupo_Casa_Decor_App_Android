...
import 'package:nucleo_casa_decor_android/features/auth/presentation/pages/auth_gate_page.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingData> _pages = [
    ...
    OnboardingData(
      ...
      title: 'Troque seus pontos por experiências',
    ),
  ];
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            height:
                size.height *
                0.5, // Reduzido de 0.6 para 0.5 para melhor ajuste
