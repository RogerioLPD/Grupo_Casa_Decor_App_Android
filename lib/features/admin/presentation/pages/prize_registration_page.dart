...
import 'package:nucleo_casa_decor_android/features/rewards/presentation/widgets/reward_grid.dart';
...
class PrizeRegistrationScreen extends StatefulWidget {
  ...
  @override
  State<PrizeRegistrationScreen> createState() =>
      _PrizeRegistrationScreenState();
}
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Prêmio cadastrado com sucesso!')),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Erro ao cadastrar prêmio.')),
        );
      }
    }
  }
