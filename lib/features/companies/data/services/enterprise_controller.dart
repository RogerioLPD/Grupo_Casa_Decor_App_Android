...
import 'package:nucleo_casa_decor_android/features/companies/data/models/enterprise_item.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;

class EnterpriseController {
  final StreamController<List<Company>> _companyController =
  ...
  Future<bool> deleteCompany(String companyId) async {
    ...
    try {
      ...
      final List<dynamic> comprasData = json.decode(
        utf8.decode(comprasResponse.bodyBytes),
      );
      ...
      for (var compra in comprasData) {
        ...
        if (compraId != null) {
          ...
          if (desvincularResponse.statusCode != 200 &&
              desvincularResponse.statusCode != 204) {
            log(
              'Erro ao desvincular compra $compraId. Status: ${desvincularResponse.statusCode}',
            );
            return false;
          }
        }
      ...
      final deleteUrl = Uri.parse(
        'https://apicasadecor.com/api/empresas/$companyId/',
      );
