...
import 'package:nucleo_casa_decor_android/features/landing/presentation/widgets/animated_section.dart';
    ...
    return Wrap(
      ...
      children: [
        ...
        _StepCard(
          ...
          description:
              'Especifique em lojas parceiras e apresente seu código de identificação.',
        ...
        _StepCard(
          ...
          description:
              'Receba pontos automaticamente baseados no valor das suas especificações.',
          icon: Icons.stars,
          theme: theme,
        ),
        _StepCard(
    ...
    return Column(
      children: [
        ...
        _StepCard(
          ...
          title: 'Acumule Pontos',
          description:
              'Receba pontos automaticamente baseados no valor das suas compras.',
          icon: Icons.stars,
          theme: theme,
          isMobile: true,
        ),
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: widget.theme.colorScheme.primaryContainer.withAlpha(
                      50,
                    ),
