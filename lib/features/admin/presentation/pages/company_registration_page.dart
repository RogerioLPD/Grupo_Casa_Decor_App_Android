...
import 'package:nucleo_casa_decor_android/features/companies/data/models/company.dart';
import 'package:nucleo_casa_decor_android/features/admin/data/services/administrator_controller.dart';
import 'package:nucleo_casa_decor_android/features/companies/data/services/enterprise_controller.dart';
import 'package:nucleo_casa_decor_android/features/admin/data/models/company_model.dart';
import 'package:nucleo_casa_decor_android/features/companies/presentation/widgets/company_list.dart';
import 'package:nucleo_casa_decor_android/shared/presentation/widgets/responsive_layout.dart';
...
class _CompanyRegistrationScreenState extends State<CompanyRegistrationScreen>
  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        setState(() {
          _imageBytes =
              result.files.first.bytes; // Atribui os bytes para exibir a imagem
        });
      }
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      obscureText:
          isPassword ? !_senhaVisivel : obscureText, // 🔹 controla visibilidade
      validator: validator,
      decoration: InputDecoration(
        labelText: label,
