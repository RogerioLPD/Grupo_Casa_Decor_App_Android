...
import 'package:nucleo_casa_decor_android/features/rewards/data/models/reward.dart';
...
class _RewardsScreenState extends State<RewardsScreen>
  ...
  void initState() {
    super.initState();
    debugPrint('[RewardsScreen] initState executado');
  ...
  void _filterRewards(String query) {
    if (query.isEmpty) {
      ...
      setState(() {
        _filteredRewards =
            _controller.awardsList
                .cast<RewardModel>()
                .where(
                  (reward) =>
                      (reward.titulo ?? '').toLowerCase().contains(
                        query.toLowerCase(),
                      ) ||
                      (reward.descricao ?? '').toLowerCase().contains(
                        query.toLowerCase(),
                      ),
                )
                .toList();
          ...
          children: [
            ...
            StreamBuilder<double>(
              ...
              builder: (context, snapshot) {
                debugPrint(
                  "Snapshot data: ${snapshot.data} - HasData: ${snapshot.hasData}",
                );
...
class RewardCard extends StatelessWidget {
  ...
  final bool
  canRedeem; // Agora será ignorado, mas mantemos para compatibilidade
