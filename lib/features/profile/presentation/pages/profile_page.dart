...
import 'package:nucleo_casa_decor_android/features/specifier/data/models/sample_data.dart';
...
import 'package:nucleo_casa_decor_android/features/auth/data/services/authentication_controller.dart';
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  void initState() {
    ...
    _userSubscription = widget.controller.userController.stream.listen((
      userDetails,
    ) {
      if (mounted) {
        setState(() {
          ...
          children: [
            ...
            StreamBuilder<double>(
              ...
              builder: (context, snapshot) {
                final totalPoints = double.parse(
                ...
                Expanded(
                  child: StreamBuilder<double>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      // Formata os valores
                      String displayPoints = totalPoints
                          .toStringAsFixed(2)
                          .replaceAll('.', '.');
